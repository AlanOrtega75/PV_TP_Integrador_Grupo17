...
import {
  AppBar, Toolbar, Typography, Button, Box, Avatar, Chip, Divider,
} from '@mui/material';
import {
...
const Header = () => {
  ...
  return (
    <AppBar position="sticky">
      <Toolbar sx={{ gap: { xs: 1, sm: 2 }, flexWrap: 'wrap', rowGap: 1, py: { xs: 1, sm: 0 } }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, ml: 'auto' }}>
          ...
          <Divider
            ...
            sx={{ display: { xs: 'none', sm: 'block' }, borderColor: 'rgba(255, 255, 255, 0.3)', mx: 0.5 }}
          />
          <Button
            color="inherit"
            variant="outlined"
